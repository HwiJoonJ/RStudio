...
for(i in 0:14) {
  ...
  # NA값들을 모두 중앙값으로 대체
  dat[[actual_col]] <- replace_na_with_median(dat[[actual_col]])
  dat[[setpoint_col]] <- replace_na_with_median(dat[[setpoint_col]])
  
  # Plotting
  plot(dat[[actual_col]], col = "blue", ylab = "Measurements", xlab = "Index",
     main = paste("Actual vs Setpoint - Measurement", i), ylim=c(0,33))
  points(dat[[setpoint_col]], col = "red")
